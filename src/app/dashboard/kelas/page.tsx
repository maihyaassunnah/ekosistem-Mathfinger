          ...
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 space-y-4 shadow-2xl border border-slate-100">
            ...
            <form onSubmit={editingClass ? handleSubmitEdit : handleSubmitAdd} className="space-y-3 text-xs">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-500 font-bold mb-1">Nama Kelas</label>
                  <input
                    type="text"
                    required
                    value={formData.name}
                ...
                <div>
                  <label className="block text-slate-500 font-bold mb-1">Pilihan Cabang</label>
                  <select
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-500 font-bold mb-1">Hari Pertemuan</label>
                  <input
                    type="text"
                    required
                    value={formData.days}
                ...
                <div>
                  <label className="block text-slate-500 font-bold mb-1">Jam Les</label>
                  <input
                    type="text"
                    required
                    value={formData.time}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-500 font-bold mb-1">Nama Pengajar</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-slate-500 font-bold mb-1">Ruangan</label>
                  <input
                    type="text"
                    required
                    value={formData.room}
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div>
                  <label className="block text-slate-500 font-bold mb-1">Kapasitas</label>
                  <input
                    type="number"
                    min={1}
                    max={50}
              ...
              <div className="pt-3 flex gap-2">
                ...
                <button
                  type="submit"
                  className="flex-1 py-2.5 rounded-xl bg-[#4338CA] text-white font-bold hover:bg-[#3730A3]"
                >
                  ...
                  <div key={st.id} className="pt-2 flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <div className="text-[10px] text-slate-400">#{st.studentCode} • Ortu: {st.parentName}</div>
                      </div>
                    </div>
