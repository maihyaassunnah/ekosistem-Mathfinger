...
export default function RaporPage() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-[1400px] mx-auto min-h-screen">
      ...
      <div className="no-print flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white dark:bg-[#0e1c16] p-5 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-xs">
        <div>
        ...
        <div className="flex items-center gap-2.5 flex-wrap">
          ...
          <select
            ...
            className="px-3 py-2 rounded-xl bg-slate-50 dark:bg-[#0b1812] border border-slate-200 dark:border-slate-700 text-xs font-bold text-slate-700 dark:text-slate-300 focus:outline-none focus:ring-2 focus:ring-[#059669]"
          >
          ...
          <select
            ...
            className="px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-[#0b1812] border border-slate-200 dark:border-slate-700 text-xs font-bold text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-[#059669] max-w-[200px]"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#0e1c16] hover:bg-slate-50 dark:hover:bg-slate-800 text-xs font-bold text-slate-700 dark:text-slate-200 transition-all cursor-pointer shadow-2xs"
          >
          ...
          <button
            type="button"
            onClick={handlePrint}
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#059669] hover:bg-[#047857] text-white text-xs font-bold transition-all shadow-xs cursor-pointer"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl border border-emerald-200 dark:border-emerald-800 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-800 dark:text-emerald-300 text-xs font-bold transition-all cursor-pointer"
          >
      ...
      <div className="bg-[#0b131b] p-4 sm:p-8 md:p-12 rounded-3xl shadow-xl flex justify-center items-center">
        ...
        >
          {/* 1. Header Box: Solid Forest Green */}
          <div className="bg-[#059669] rounded-2xl p-5 sm:p-6 text-white shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="sm:text-right space-y-1.5 flex flex-col sm:items-end">
              <span className="inline-block px-3 py-1 rounded-md bg-[#035438] text-[#34d399] text-[10px] sm:text-[11px] font-extrabold tracking-wider uppercase shadow-2xs">
                RAPOR DIGITAL
              </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-[#ecfdf5] border border-[#a7f3d0] text-center space-y-0.5">
              <div className="text-[10px] sm:text-[11px] font-extrabold uppercase text-[#047857] tracking-wider">
                PERSENTASE PRESENSI
              </div>
              <div className="text-3xl sm:text-4xl font-black text-[#059669] my-1">
                  ...
                  {studentGrades.length === 0 ? (
                    ...
                    studentGrades.map((g) => (
                      <tr key={g.id} className="hover:bg-slate-50/50">
                        ...
                        <td className="py-2.5 px-4 text-right font-bold text-[#059669] font-mono">
                          {g.score} / 100
                        </td>
                      </tr>
                    ))
            ...
            <div className="flex items-center justify-between border-b border-slate-800 pb-3 text-white">
              ...
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  onClick={handlePrint}
                  className="px-3.5 py-1.5 rounded-xl bg-[#059669] hover:bg-[#047857] text-white text-xs font-bold flex items-center gap-1.5 cursor-pointer"
                >
                  <Printer className="w-3.5 h-3.5" />
                  Cetak / Unduh PDF
                </button>
