        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-8 h-8 rounded-full bg-[#059669] hover:bg-[#047857] text-white flex items-center justify-center transition-all shadow-sm"
                ...
                <tr key={st.id} className="hover:bg-slate-50/70 transition-colors">
                  ...
                  <td className="p-3.5">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-emerald-100 text-slate-700 hover:text-emerald-900 text-[11px] font-bold transition-all shadow-2xs cursor-pointer"
                    >
      ...
      {(isAddOpen || editingStudent) && (
        <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-xl w-full p-6 space-y-4 shadow-2xl border border-slate-100 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={editingStudent ? handleSubmitEdit : handleSubmitAdd} className="space-y-3 text-xs">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-slate-500 font-bold mb-1">ID Kode Siswa</label>
                  <input
                    type="text"
                    required
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div>
                  <label className="block text-slate-500 font-bold mb-1">Cabang</label>
                  <select
                    value={form.branch}
                ...
                <div>
                  <label className="block text-slate-500 font-bold mb-1">Kelas Bimbingan</label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-500 font-bold mb-1">Nama Orang Tua / Wali</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-slate-500 font-bold mb-1">WhatsApp Orang Tua</label>
                  <input
                    type="text"
                    required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-500 font-bold mb-1">Tempat & Tanggal Lahir</label>
                ...
                <div>
                  <label className="block text-slate-500 font-bold mb-1">Keterangan Kelas Sekolah</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="block text-slate-500 font-bold mb-1">Alamat Lengkap</label>
                <input
                  type="text"
                  value={form.address}
              ...
              <div>
                <label className="block text-slate-500 font-bold mb-1">Tingkat Level Kurikulum</label>
                <select
          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl border border-slate-100">
            ...
            <div className="space-y-2 text-xs">
              <div className="p-3 bg-emerald-50 rounded-xl space-y-1">
                <div className="font-extrabold text-emerald-950 text-sm">{viewingDetail.name}</div>
                <div className="text-emerald-700 font-medium">#{viewingDetail.studentCode} • Cabang {viewingDetail.branch}</div>
              </div>
              <div className="grid grid-cols-2 gap-2 text-slate-600 pt-2">
                ...
                <div>Status: <span className="text-emerald-700 font-bold">Aktif</span></div>
          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl border border-slate-100">
            ...
            <div className="space-y-3 text-xs">
              <div className="p-3 bg-emerald-50 rounded-xl border border-emerald-200">
                <div className="font-bold text-emerald-900">{viewingGuide.name}</div>
                <div className="text-emerald-700 font-semibold">{viewingGuide.levelCurriculum}</div>
              </div>
            ...
            <button
              type="button"
              onClick={() => setViewingGuide(null)}
              className="w-full py-2.5 rounded-xl bg-[#059669] text-white font-bold text-xs hover:bg-[#047857]"
            >
              Tutup Panduan
            </button>
          </div>
