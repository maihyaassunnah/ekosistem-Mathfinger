...
function WebsiteManagementContent() {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-7xl mx-auto space-y-6">
      {/* Toast Notification */}
      {saveAlert && (
        <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-4 py-3 bg-[#059669] text-white font-semibold text-sm rounded-xl shadow-lg animate-in slide-in-from-bottom-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
        <div>
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-emerald-100 dark:bg-emerald-950/80 text-[#059669] flex items-center justify-center font-bold">
        ...
        <div className="flex items-center gap-2.5">
          <Link
            href="/"
            target="_blank"
            className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-100 dark:bg-[#13271f] hover:bg-slate-200 dark:hover:bg-[#1a382c] text-slate-700 dark:text-slate-200 text-xs font-bold transition-all"
          >
      ...
      <div className="flex items-center gap-2 border-b border-slate-200 dark:border-slate-800 overflow-x-auto pb-1 text-xs font-bold scrollbar-none">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2.5 rounded-t-xl transition-all border-b-2 cursor-pointer whitespace-nowrap ${
            activeTab === "hero"
              ? "border-[#059669] text-[#059669] bg-emerald-50/50 dark:bg-emerald-950/30"
        ...
        <form onSubmit={handleSaveHero} className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              {/* Promo Banner Card */}
              <div className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 space-y-4 shadow-xs">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-[#08120e] border border-slate-200 dark:border-slate-800 text-sm font-bold text-slate-900 dark:text-slate-100 focus:outline-hidden focus:border-emerald-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-[#08120e] border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-slate-100 focus:outline-hidden focus:border-emerald-500 leading-relaxed"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-[#059669] hover:bg-[#047857] text-white text-xs font-bold shadow-sm transition-all cursor-pointer"
                >
            ...
            <div className="space-y-4">
              <div className="p-5 rounded-2xl bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 space-y-4">
                ...
                <div className="space-y-3 pt-2 text-center">
                  <span className="inline-block px-3 py-1 rounded-full text-[10px] font-bold bg-emerald-50 dark:bg-emerald-950/60 text-emerald-800 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800">
                    {heroForm.tagline}
                  </span>
                  ...
                  <div className="pt-2 flex flex-col gap-2">
                    <div className="w-full py-2.5 rounded-xl bg-[#059669] text-white font-bold text-xs">
                      Daftar Coba Gratis (Trial)
                    </div>
                    <div className="w-full py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-xs font-bold text-slate-700 dark:text-slate-300">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#059669] hover:bg-[#047857] text-white text-xs font-bold shadow-xs transition-all cursor-pointer"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {landingPrograms.map((prog) => (
              <div
                key={prog.id}
                className={`p-5 rounded-2xl bg-white dark:bg-[#0e1c16] border transition-all relative flex flex-col justify-between ${
                  prog.popular
                    ? "border-[#059669] shadow-md ring-1 ring-[#059669]"
                    : "border-slate-200 dark:border-slate-800 shadow-xs"
                }`}
              >
                {prog.popular && (
                  <span className="absolute -top-2.5 right-4 px-2 py-0.5 rounded-full bg-[#059669] text-white text-[10px] font-extrabold uppercase tracking-wider">
                    Paling Diminati
                  </span>
                )}
                ...
                <div className="flex items-center gap-2 pt-4 mt-4 border-t border-slate-100 dark:border-slate-800">
                  <button
                    ...
                    className="flex-1 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 text-xs font-bold hover:bg-slate-50 dark:hover:bg-[#13271f] transition-colors"
                  >
                    Edit
                  </button>
                  <button
          ...
          {showProgramModal && (
            <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-4">
              <div className="bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 rounded-2xl max-w-lg w-full p-6 space-y-4 max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {landingTestimonials.map((testi) => (
              <div
                key={testi.id}
                className="p-5 rounded-2xl bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 flex flex-col justify-between space-y-4 shadow-xs"
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
          ...
          {showTestiModal && (
            <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-4">
              <div className="bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 rounded-2xl max-w-md w-full p-6 space-y-4 shadow-2xl">
                <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
                  <h3 className="font-bold text-slate-900 dark:text-slate-100 text-base">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-[#08120e] border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-slate-100"
                      >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <select
                ...
                className="px-3 py-1.5 rounded-xl bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 text-xs font-semibold text-slate-700 dark:text-slate-300"
              >
                        ...
                        <td className="py-3.5 px-4 text-right">
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs transition-all shadow-2xs"
      ...
      {activeTab === "partners" && (
        <div className="space-y-6">
          {/* Header Card */}
          <div className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#059669] hover:bg-emerald-700 text-white text-xs font-bold transition-all shadow-xs cursor-pointer shrink-0"
            >
              <Plus className="w-4 h-4" />
          ...
          <div className="p-5 rounded-2xl bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-[#091712] dark:to-[#0c1f18] border border-emerald-200 dark:border-emerald-800/80 shadow-xs space-y-3">
            <div className="flex items-center justify-between">
            ...
            <div className="overflow-x-auto py-3 bg-white/70 dark:bg-[#07110c]/70 rounded-xl border border-emerald-100 dark:border-emerald-900/60 flex gap-4 items-center px-4 scrollbar-thin">
              {landingPartners.filter((p) => p.active).map((p) => (
                <div
                  key={p.id}
                  className="px-4 py-2 rounded-xl bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 shadow-2xs flex items-center gap-2.5 shrink-0"
                >
                  <div className="w-8 h-8 rounded-lg bg-emerald-100 dark:bg-emerald-950 text-emerald-800 dark:text-emerald-300 font-black text-xs flex items-center justify-center">
          ...
          {/* Partners Table */}
          <div className="rounded-2xl bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 shadow-xs overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800 font-medium">
                  {landingPartners.map((partner) => (
                    <tr
                      key={partner.id}
                      className="hover:bg-slate-50/70 dark:hover:bg-[#13271f]/40 transition-colors"
                    >
                      <td className="py-3.5 px-4">
                      ...
                      <td className="py-3.5 px-4">
                        <span className="px-2.5 py-0.5 rounded-full bg-slate-100 dark:bg-[#13271f] text-slate-700 dark:text-slate-300 text-[11px] font-semibold border border-slate-200 dark:border-slate-800">
                          {partner.category}
                        </span>
                      </td>
                      <td className="py-3.5 px-4 text-slate-500">
            ...
            <form onSubmit={handleSavePartner} className="space-y-3.5 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-[#08120e] border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl bg-slate-50 dark:bg-[#08120e] border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 uppercase"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-100 dark:border-slate-800">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 rounded-xl bg-[#059669] hover:bg-emerald-700 text-white font-bold transition-all shadow-xs cursor-pointer"
                >
                  Simpan Mitra
                </button>
              </div>
