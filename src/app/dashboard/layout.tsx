  ...
  return (
    <div className="h-screen w-full flex overflow-hidden bg-math-pattern text-slate-900 dark:text-slate-100 font-sans relative">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden min-w-0">
        ...
        {!isDashboardHome && (
          <header className="lg:hidden flex items-center justify-between px-4 py-3 bg-white/95 dark:bg-[#0e1c16]/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 shrink-0 z-30 shadow-2xs">
            <div className="flex items-center gap-2.5">
              ...
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-white p-0.5 border border-emerald-100 dark:border-emerald-800 flex items-center justify-center font-bold shadow-2xs">
                  <img
                    src="/logo.png"
        ...
        <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 dark:bg-[#0e1c16]/95 backdrop-blur-xl border-t border-slate-200/80 dark:border-slate-800 px-3 pt-1.5 pb-2.5 shadow-2xl">
          <div className="max-w-md md:max-w-xl mx-auto flex items-end justify-around relative">
            ...
            >
              <div
                className={`w-11 h-11 -mt-4 rounded-full flex items-center justify-center shadow-lg transition-transform group-hover:scale-105 border-4 border-white dark:border-[#0e1c16] ${
                  pathname === "/dashboard"
