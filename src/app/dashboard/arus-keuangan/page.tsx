    ...
    <div className="p-4 sm:p-6 lg:p-8 space-y-6 max-w-[1400px] mx-auto min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div className="flex items-start gap-3">
          <div className="w-11 h-11 rounded-2xl bg-emerald-50 dark:bg-emerald-950/60 text-[#059669] dark:text-[#10b981] flex items-center justify-center shrink-0 shadow-2xs">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          {/* Dropdown Bulan */}
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-2xl bg-white dark:bg-[#0e1c16] border border-slate-200/80 dark:border-slate-800 shadow-2xs">
      ...
      <div className="bg-white/80 dark:bg-[#0e1c16] p-1.5 rounded-2xl border border-slate-200/80 dark:border-slate-800 flex items-center gap-1.5 flex-wrap shadow-2xs">
        {[
      ...
      {/* Toast Notification */}
      {toastMessage && (
        <div className="p-3.5 rounded-2xl bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 text-xs font-bold text-emerald-900 dark:text-emerald-200 flex items-center gap-2 animate-in fade-in">
      ...
      {activeSubTab === "ringkasan" && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-white dark:bg-[#0e1c16] rounded-3xl border border-slate-200/80 dark:border-slate-800 p-5 shadow-xs flex items-center justify-between">
              ...
              <div className="w-11 h-11 rounded-2xl bg-emerald-50 dark:bg-emerald-950/60 text-[#059669] dark:text-[#10b981] flex items-center justify-center shrink-0">
            ...
            <div className="bg-white dark:bg-[#0e1c16] rounded-3xl border border-slate-200/80 dark:border-slate-800 p-5 shadow-xs flex items-center justify-between">
              <div className="space-y-1">
                ...
                <div className="text-xl sm:text-2xl font-extrabold text-[#059669] dark:text-[#10b981]">
            ...
            <div className="bg-white dark:bg-[#0e1c16] rounded-3xl border border-slate-200/80 dark:border-slate-800 p-5 shadow-xs flex items-center justify-between">
              ...
              <div className="w-11 h-11 rounded-2xl bg-blue-50 dark:bg-blue-950/40 text-[#2563eb] flex items-center justify-center shrink-0">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div className="lg:col-span-8 bg-white dark:bg-[#0e1c16] rounded-3xl border border-slate-200/80 dark:border-slate-800 p-6 space-y-6 shadow-xs">
              <div>
                      ...
                      >
                        <div className="w-full flex items-end justify-center gap-1.5 sm:gap-2 h-full">
                          ...
                          <div
                            ...
                            className="w-4 sm:w-6 bg-[#059669] hover:bg-[#047857] rounded-t-lg transition-all relative group cursor-pointer"
                          >
            ...
            <div className="lg:col-span-4 bg-white dark:bg-[#0e1c16] rounded-3xl border border-slate-200/80 dark:border-slate-800 p-6 space-y-4 shadow-xs">
              <div className="space-y-1">
              ...
              {/* 3 Insight Cards with rounded green borders */}
              <div className="space-y-3 pt-1">
                {/* Insight 1: Sumber pemasukan terbesar */}
                <div className="p-4 rounded-2xl border border-emerald-100 dark:border-emerald-950 bg-slate-50/50 dark:bg-[#0b1812] flex items-start gap-3">
        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#059669] hover:bg-[#047857] text-white text-xs font-bold cursor-pointer shadow-sm"
            >
                  ...
                  {branchFilteredTransactions
                    ...
                    .map((t) => (
                      <tr key={t.id} className="hover:bg-slate-50/50">
                        ...
                        <td className="py-3 px-4 text-right font-extrabold text-[#059669]">
        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#0e1c16] hover:bg-slate-50 text-xs font-bold text-slate-700 dark:text-slate-300"
            >
      ...
      {activeSubTab === "laporan" && (
        <div className="bg-white dark:bg-[#0e1c16] rounded-3xl border border-slate-200/80 dark:border-slate-800 p-6 space-y-6 shadow-xs">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-4">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-2xl bg-white dark:bg-[#0e1c16] border border-emerald-100 dark:border-emerald-800 p-0.5 flex items-center justify-center shrink-0 shadow-2xs">
                <img
                  src="/logo.png"
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-[#059669] text-white text-xs font-bold flex items-center gap-1.5"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs">
            {/* Rincian Pemasukan */}
            <div className="p-4 rounded-2xl bg-slate-50 dark:bg-[#0b1812] border border-slate-200/80 dark:border-slate-800 space-y-3">
            ...
            >
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#0b1812] text-slate-900 dark:text-slate-100 font-semibold"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#0b1812] text-slate-900 dark:text-slate-100"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#0b1812] text-slate-900 dark:text-slate-100 font-bold"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#0b1812] text-slate-900 dark:text-slate-100 font-bold text-rose-600"
                  />
                </div>
              </div>
