...
export default function Home() {
      ...
      items: [
        {
          ...
          href: "#keunggulan",
          icon: Zap,
          color: "text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-100/80 dark:border-emerald-900/60",
        },
        {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-[#F8FAFC] dark:bg-[#08120e] text-[#0F172A] dark:text-[#f8fafc] transition-colors duration-200 selection:bg-emerald-500 selection:text-white">
      {/* 1. TOP PROMO ANNOUNCEMENT BAR */}
      {landingHero.promoActive && (
        <div className="bg-gradient-to-r from-[#064E3B] via-[#059669] to-[#047857] text-white text-xs font-semibold py-2.5 px-4 text-center shadow-xs relative z-50">
      ...
      {/* 2. TOP STICKY NAVBAR */}
      <header className="border-b border-slate-200/80 dark:border-slate-800 bg-white/95 dark:bg-[#0e1c16]/95 backdrop-blur-md sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                ...
                >
                  <button
                    ...
                    className={`inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
                      isOpen
                        ? "bg-slate-100 dark:bg-[#13271f] text-emerald-600 dark:text-emerald-400"
                        ...
                        {menu.items.map((sub, sIdx) => {
                          ...
                          if (sub.action) {
                            return (
                              <button
                                ...
                                className="w-full flex items-start gap-3 p-2.5 rounded-xl text-left hover:bg-emerald-50/70 dark:hover:bg-[#13271f] transition-all group cursor-pointer"
                              >
                          ...
                          return (
                            <a
                              ...
                              className="flex items-start gap-3 p-2.5 rounded-xl hover:bg-slate-50 dark:hover:bg-[#13271f] transition-all group cursor-pointer"
                            >
                              <div className={`p-2 rounded-xl shrink-0 ${sub.color}`}>
                                <SubIcon className="w-4 h-4" />
                              </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/login"
              className="hidden sm:inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[#059669] hover:bg-[#047857] text-white text-xs font-bold transition-all shadow-xs cursor-pointer"
            >
        ...
        {mobileNavOpen && (
          <div className="lg:hidden border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0e1c16] px-4 py-4 space-y-3 shadow-xl animate-in fade-in">
                ...
                return (
                  <div key={menu.id} className="border-b border-slate-100 dark:border-slate-800/80 pb-1">
                    <button
                      ...
                      className="w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-xs font-bold text-slate-800 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-[#13271f]"
                    >
                        ...
                        {menu.items.map((sub, sIdx) => {
                          ...
                          return (
                            <a
                              ...
                              className="flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-[#13271f] hover:text-emerald-600"
                            >
                              <div className={`p-1.5 rounded-lg shrink-0 ${sub.color}`}>
                                <SubIcon className="w-3.5 h-3.5" />
                              </div>
            ...
            <div className="pt-3 border-t border-slate-100 dark:border-slate-800 space-y-2">
              ...
              <Link
                href="/login"
                onClick={() => setMobileNavOpen(false)}
                className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-[#059669] text-white text-xs font-bold shadow-xs"
              >
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden py-14 sm:py-20 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-emerald-400/10 dark:bg-emerald-500/5 blur-3xl rounded-full pointer-events-none -z-10" />
          ...
          <div className="text-center max-w-3xl mx-auto space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-3">
              <button
                type="button"
                onClick={() => handleOpenTrial()}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-2xl bg-[#059669] hover:bg-[#047857] text-white font-extrabold text-sm shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all cursor-pointer"
              >
              ...
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 text-slate-800 dark:text-slate-200 font-bold text-sm hover:bg-slate-50 dark:hover:bg-[#13271f] transition-all shadow-xs"
              >
            ...
            <div className="pt-8 grid grid-cols-2 md:grid-cols-4 gap-3 text-left">
              {/* Stat 1: Siswa Aktif */}
              <div className="p-3.5 rounded-2xl bg-white dark:bg-[#0e1c16] border border-slate-200/80 dark:border-slate-800 shadow-2xs hover:border-emerald-500/50 transition-colors">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="p-1.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/70 text-emerald-600 dark:text-emerald-400 border border-emerald-100/80 dark:border-emerald-900/60">
              ...
              <div className="p-3.5 rounded-2xl bg-white dark:bg-[#0e1c16] border border-slate-200/80 dark:border-slate-800 shadow-2xs hover:border-emerald-500/50 transition-colors">
                <div className="flex items-center justify-between mb-1.5">
                  <span className="p-1.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/70 text-emerald-600 dark:text-emerald-400 border border-emerald-100/80 dark:border-emerald-900/60">
                    <Star className="w-4 h-4 fill-emerald-600 dark:fill-emerald-400 text-emerald-600 dark:text-emerald-400" />
                  </span>
                  <span className="text-[9px] font-extrabold uppercase px-2 py-0.5 rounded-full bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800">
                    Rating 4.9
                  </span>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-5 text-center space-y-1.5">
            <span className="text-[11px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest flex items-center justify-center gap-1.5">
          ...
          <div className="relative w-full overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]">
            <div className="flex gap-4 animate-marquee py-2 w-max">
              {[
                ...
                <div
                  key={`${partner.id}-${idx}`}
                  className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-white dark:bg-[#0e1c16] border border-slate-200/80 dark:border-slate-800 shadow-2xs hover:shadow-md hover:border-emerald-500 transition-all shrink-0 select-none group"
                >
                  <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-emerald-600 to-teal-500 text-white font-black text-xs flex items-center justify-center shadow-xs shrink-0 group-hover:scale-105 transition-transform">
        ...
        <section
          id="keunggulan"
          className="py-16 sm:py-20 bg-white dark:bg-[#0e1c16] border-y border-slate-200/80 dark:border-slate-800"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="p-6 rounded-2xl bg-slate-50 dark:bg-[#0b1812] border border-slate-200/80 dark:border-slate-800 space-y-3.5 hover:border-emerald-500 transition-colors shadow-2xs">
                <div className="w-12 h-12 rounded-2xl bg-emerald-50 dark:bg-emerald-950/70 text-emerald-600 dark:text-emerald-400 border border-emerald-100/80 dark:border-emerald-900/60 flex items-center justify-center font-bold shadow-2xs">
        ...
        <section
          id="guru"
          className="py-16 sm:py-20 bg-white dark:bg-[#0e1c16] border-b border-slate-200/80 dark:border-slate-800"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
            ...
            <div className="p-4 rounded-2xl bg-emerald-50/70 dark:bg-[#0c2017] border border-emerald-200 dark:border-emerald-800/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-[#059669] text-white flex items-center justify-center shrink-0">
              ...
              <button
                type="button"
                onClick={() => handleOpenTrial()}
                className="px-4 py-2 rounded-xl bg-[#059669] hover:bg-[#047857] text-white font-bold text-xs whitespace-nowrap shadow-xs cursor-pointer shrink-0"
              >
        ...
        <section id="program" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {landingPrograms.map((prog) => (
              <div
                key={prog.id}
                className={`rounded-3xl p-6 flex flex-col justify-between transition-all duration-300 bg-white dark:bg-[#0e1c16] ${
                  prog.popular
                    ? "border-2 border-[#059669] shadow-xl ring-2 ring-emerald-500/20 relative"
                    : "border border-slate-200 dark:border-slate-800 shadow-sm hover:shadow-md"
                }`}
              >
                {prog.popular && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-3 py-0.5 rounded-full bg-[#059669] text-white text-[11px] font-extrabold uppercase tracking-wider shadow-sm">
                    Paling Diminati
                  </div>
                )}
                  ...
                  <button
                    ...
                    className={`w-full py-2.5 rounded-xl text-xs font-extrabold transition-all shadow-xs cursor-pointer ${
                      prog.popular
                        ...
                        : "bg-slate-100 dark:bg-[#13271f] hover:bg-slate-200 dark:hover:bg-[#1a382c] text-slate-800 dark:text-slate-200"
                    }`}
                  >
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Item 1 */}
              <div className="p-6 rounded-2xl bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 space-y-3 shadow-xs">
                <div className="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-950/70 text-emerald-600 dark:text-emerald-400 border border-emerald-100/80 dark:border-emerald-900/60 flex items-center justify-center font-bold">
        ...
        <section id="cabang" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Cabang Singkut */}
            <div className="p-6 sm:p-8 rounded-3xl bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 space-y-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex items-center justify-between">
              ...
              <div className="pt-3 flex flex-col sm:flex-row gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-slate-200 text-xs font-bold hover:bg-slate-50 dark:hover:bg-[#13271f]"
                >
                  Daftar Trial
                </button>
              </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div className="flex justify-center">
              <div className="inline-flex p-1.5 rounded-2xl bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 shadow-2xs">
                <button
                  type="button"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
              ...
              <div className="lg:col-span-8 rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-md bg-slate-200 dark:bg-slate-800 min-h-[380px] sm:min-h-[440px] relative">
                <iframe
                  ...
                  allowFullScreen
                />
                <div className="absolute top-4 left-4 bg-white/95 dark:bg-[#0e1c16]/95 backdrop-blur-md px-3.5 py-2 rounded-xl shadow-md border border-slate-200 dark:border-slate-800 text-xs font-bold text-slate-800 dark:text-slate-100 flex items-center gap-2 pointer-events-none">
              ...
              <div className="lg:col-span-4 p-6 sm:p-7 rounded-3xl bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col justify-between space-y-6">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
        ...
        <section
          id="testimoni"
          className="py-16 sm:py-24 bg-white dark:bg-[#0e1c16] border-y border-slate-200/80 dark:border-slate-800"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            <div className="text-center max-w-2xl mx-auto space-y-3">
              <span className="text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-1 text-emerald-500 dark:text-emerald-400">
                      {Array.from({ length: testi.rating }).map((_, i) => (
                        <Star key={i} className="w-4 h-4 fill-emerald-500 dark:fill-emerald-400" />
                      ))}
                    </div>
          ...
          <div className="space-y-3">
            {faqs.map((faq, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0e1c16] overflow-hidden transition-colors"
                >
                  <button
                    type="button"
                  ...
                  >
                    <span>{faq.q}</span>
                    {isOpen ? (
                      <ChevronUp className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0 ml-2" />
                    ) : (
                      <ChevronDown className="w-4 h-4 text-emerald-600/70 dark:text-emerald-400/70 shrink-0 ml-2" />
                    )}
                  </button>
        ...
        <section className="py-14 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="rounded-3xl bg-gradient-to-r from-[#064E3B] via-[#059669] to-[#047857] text-white p-8 sm:p-12 md:p-16 text-center space-y-6 shadow-2xl relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
              <button
                type="button"
                onClick={() => handleOpenTrial()}
                className="w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-white hover:bg-slate-100 text-emerald-900 font-extrabold text-sm shadow-lg hover:shadow-xl transition-all cursor-pointer"
              >
      ...
      {/* 11. FOOTER */}
      <footer className="border-t border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#0e1c16] py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 text-xs">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-1.5">
              <Link
                href="/login"
                className="inline-block text-emerald-600 dark:text-emerald-400 hover:underline font-bold"
              >
      ...
      {showTrialModal && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white dark:bg-[#0e1c16] border border-slate-200 dark:border-slate-800 rounded-3xl max-w-lg w-full p-6 sm:p-7 space-y-5 shadow-2xl relative max-h-[95vh] overflow-y-auto">
            <button
              type="button"
            ...
            {!trialSuccess ? (
              <form onSubmit={handleSubmitTrial} className="space-y-4">
                ...
                <div className="space-y-3 pt-1">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-[#08120e] border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-slate-100 focus:outline-hidden focus:border-emerald-500"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-[#08120e] border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-slate-100"
                      >
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2 rounded-xl bg-slate-50 dark:bg-[#08120e] border border-slate-200 dark:border-slate-800 text-xs text-slate-900 dark:text-slate-100 focus:outline-hidden focus:border-emerald-500"
                    />
                  </div>
                </div>
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    className="w-full py-3 rounded-xl bg-[#059669] hover:bg-[#047857] text-white font-extrabold text-xs shadow-md transition-all cursor-pointer flex items-center justify-center gap-2"
                  >
                    <Sparkles className="w-4 h-4 text-emerald-200" />
              ...
              <div className="py-4 text-center space-y-4">
                ...
                <div className="p-4 rounded-2xl bg-emerald-50 dark:bg-[#13271f] text-left text-xs space-y-1 text-slate-700 dark:text-slate-300 border border-emerald-100 dark:border-emerald-900">
                ...
                <div className="space-y-2 pt-2">
                  <button
                    ...
                    className="w-full py-3 rounded-xl bg-[#059669] hover:bg-[#047857] text-white font-bold text-xs shadow-sm flex items-center justify-center gap-2 transition-all cursor-pointer"
                  >
                    <MessageCircle className="w-4 h-4" />
